...
export function DocumentEditor({ onPreviewGenerated }: DocumentEditorProps) {
  const [template, setTemplate] = React.useState(`# DocuChain Sample Contract

This template demonstrates dynamic placeholders, preview metadata and signature slots.
...
Please review all sections carefully before signing. When you click “Sign Document”, each signature slot below will be replaced with the generated signature graphic.
...
*Generated by DocuChain*`);
  ...
  const [placeholders, setPlaceholders] = React.useState<PlaceholderRow[]>([
    ...
    { key: "party_a_name", value: "Dr. John Smith" },
    { key: "party_b_name", value: "Jane Doe, Esq." },
  ]);
