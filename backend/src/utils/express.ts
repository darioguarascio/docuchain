...
import { incrementPendingRequests, decrementPendingRequests } from '@utils/health-state.ts';
...
app.use('/api/v1/documents/verify/file', express.raw({ type: 'application/pdf', limit: '50mb' }));
app.use('/api/v1/documents/sign', express.raw({ type: 'application/pdf', limit: '50mb' }));
